...
function create_vpn_ns() {
    ...
    ip netns exec vmux_app ip link set app_vpn${1}_s master br_app mtu 1420
...
ip netns exec vmux_app ip link set pf_tap master br_app mtu 1420
ip link set pf_app_tap master br_pf_vmux mtu 1420
